...
d.ind.t(23, 17.75, 2.16, 3.30, 8, 4, a = 0.05) 
...
Group 1 Summary Statistics: M = 23.00, SD = 2.16, SE = 0.76, 95% CI [21.19, 24.81]
Group 2 Summary Statistics: M = 17.75, SD = 3.30, SE = 1.65, 95% CI [12.50, 23.00]
