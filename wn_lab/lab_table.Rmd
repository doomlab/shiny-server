...
You can view the complete tag explanation table that lists the tags, their descriptions, and relevant statistics calculated from the most recent dataset.
...
You can download the csv file of the LAB table information [here](https://github.com/doomlab/shiny-server/blob/master/wn_lab/lab_table.csv).
