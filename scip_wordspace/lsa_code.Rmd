...
```{r transform, echo = TRUE, eval = FALSE}
...
```{r lsa_svd, echo = TRUE, eval = FALSE}
#Run the SVD
...
```{r plot_neighbors, echo = TRUE, eval = FALSE}
...
```{r choose_words, echo = TRUE, eval = FALSE}
...
```{r create_multiple, echo = TRUE, eval = FALSE}
